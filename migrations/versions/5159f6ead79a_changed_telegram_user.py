...
Revision ID: 5159f6ead79a
Revises: 9b5cebb267eb
Create Date: 2024-08-30 16:59:18.085229
...
revision = '5159f6ead79a'
down_revision = '9b5cebb267eb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_telegram'), ['telegram'], unique=True)
